...
abstract class SheetApiService {
  Future<Either<String, Map<String, dynamic>>> addSheetId(
      String sheetId, String userId);
...
class SheetApiServiceImpl implements SheetApiService {
  @override
  Future<Either<String, Map<String, dynamic>>> addSheetId(
      String sheetId, String userId) async {
    try {
  ...
  Future<bool> checkSheetExists(String userId) async {
    try {
      final response =
          await sl<DioClient>().get('${ApiUrls.checkSheetExists}/$userId');

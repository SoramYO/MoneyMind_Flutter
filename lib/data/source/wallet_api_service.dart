...
abstract class WalletApiService {
  ...
  Future<Either<String, List<Transaction>>> getWalletByWalletId(String walletId);
...
class WalletApiServiceIml implements WalletApiService {
  @override
  Future<Either<String, List<Transaction>>> getWalletByUserId(String userId) async {
    try {
  ...
  @override
  Future<Either<String, List<Transaction>>> getWalletByWalletId(String walletId) async {
    try {
      final response = await sl<DioClient>().get(
